    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
              ...
              <!-- ****************************************************************************************************************************************************** -->
                <div class="nav-item {{ ($segment1 == 'users' || $segment1 == 'roles'||$segment1 == 'permission' ||$segment1 == 'user') ? 'active open' : '' }} has-sub">
                    <a href="#"><i class="ik ik-user"></i><span>{{ __('student')}}</span></a>
                    <div class="submenu-content">
                        <!-- only those have manage_user permission will get access -->
                        @can('manage_user')
                        <a href="{{url('datashow')}}" class="menu-item {{ ($segment1 == 'datashow') ? 'active' : '' }}">{{ __('Student')}}</a>
                        <a href="{{url('dataregister')}}" class="menu-item {{ ($segment1 == 'user' && $segment2 == 'create') ? 'active' : '' }}">{{ __('Add Student')}}</a>
                         @endcan
                         <!-- only those have manage_role permission will get access -->
