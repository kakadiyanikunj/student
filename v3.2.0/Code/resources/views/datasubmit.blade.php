            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Add Students')}}</h3>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="datasubmit" >
                        @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="" placeholder="Enter user name">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-control select2 @error('city') is-invalid @enderror" name="country" id="country" onchange="setStates();">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-control select2 @error('State') is-invalid @enderror" name="state" id="state" onchange="setCities();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('city') is-invalid @enderror" name="city"  id="city">
                                            <option value="">Please select a Country</option>
                                          </select>
                                        @error('city')
                                            <span class="invalid-feedback" role="alert">
