...
Route::get('/dataregister',[StudentController::class,'create']);
Route::post('/datasubmit',[StudentController::class,'store']);
Route::get('/datashow',[StudentController::class,'show']);
Route::get('/destroy/{id}',[StudentController::class,'destroy']);
Route::get('/restore/{id}',[StudentController::class,'restore']);
Route::get('/forcedelete/{id}',[StudentController::class,'forcedelete']);
Route::get('/edit/{id}',[StudentController::class,'edit']);
Route::get('/trash',[StudentController::class,'trash']);
Route::post('/dataupdate/{id}',[StudentController::class,'update']);
